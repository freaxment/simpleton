...
// Default skin: the shared Freaxment plugin design (dark, acid-lime accent, TikTok Sans).
class FamilySkin final : public SkinView
{
public:
    explicit FamilySkin (FreaxVolumeAudioProcessor&);
    ~FamilySkin() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FamilySkin)
};
